    ...
    <div className="container mx-auto px-4 py-12 md:py-16 flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
      <Card className="w-full max-w-md text-center shadow-xl">
        ...
        <CardContent>
          ...
          <p className="mb-6">
            Untuk informasi lebih lanjut atau jika Anda ingin berdonasi melalui metode lain, silakan hubungi kami di <a href="mailto:info@charityhub.org" className="text-primary hover:underline">info@charityhub.org</a>.
          </p>
