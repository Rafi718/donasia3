        ...
        <div className="flex flex-col md:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="flex flex-col gap-8 md:w-1/2 lg:max-w-2xl items-start text-left">
            ...
            <div className="flex flex-col items-start text-left w-full">
              ...
              <h1 className="text-3xl lg:text-[50px] sm:text-4xl md:text-5xl font-extrabold mb-4 text-foreground leading-tight">
                Bersama{" "}
                <span className="text-primary whitespace-nowrap">
                  Donasia.com
                </span>{" "}
                Wujudkan Perubahan Positif
              </h1>
              <p className="text-base md:text-lg text-muted-foreground lg:text-[25px]">
                Galang dana dan donasi online kini semakin mudah dilakukan
                dimanapun dan kapanpun untuk mereka yang membutuhkan.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold text-foreground mb-4">
                Mengenal <span className="text-primary">Donasia.com</span> Lebih
                Dekat
              </h2>
              <p className="text-base md:text-lg text-muted-foreground mb-6">
                Donasia.com adalah platform yang menghubungkan kebaikan hati
                para donatur dengan mereka yang membutuhkan. Kami percaya setiap
                individu memiliki kekuatan untuk membuat perubahan positif,
                sekecil apapun kontribusinya.
              </p>
              <p className="text-base md:text-lg text-muted-foreground mb-8">
                Visi kami adalah menciptakan ekosistem gotong royong digital
                yang transparan, aman, dan mudah diakses.
              </p>
              <Button
                size="lg"
                asChild
                className="bg-primary text-primary-foreground hover:bg-primary/90 text-base md:text-lg py-3 px-8 shadow-md rounded-lg transition-transform hover:scale-105"
              >
